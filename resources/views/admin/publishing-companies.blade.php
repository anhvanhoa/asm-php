...
@section('heading', 'Publishing companies')
@section('content')
    <div class="px-4 py-2">
        <div>
        ...
        <div class="flex justify-between items-center mb-4">
            <div class="inline-flex rounded-md shadow-sm" role="group">
                <a href="{{ route('admin.publishing_company.add') }}">
                    <button type="button"
                        ...
                        <tr class="bg-white border-b">
                            ...
                            <td class="px-2 py-4">
                                <div class="inline-flex rounded-md shadow-sm">
                                    <form action="{{route('admin.publishing_company.delete', $item->id)}}" method="POST">
                                        @method('DELETE')
                                        @csrf
                                    ...
                                    <a href="{{route('admin.publishing_company.edit', ['id' => $item->id])}}"
