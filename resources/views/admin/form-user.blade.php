...
@section('content')
    <div class="px-4 py-2">
        ...
        <form method="POST" enctype="multipart/form-data"
            action="{{ $isEdit ? route('admin.user.edit-handle', $data->id) : route('admin.user.add-handle') }}">
            @csrf
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 pb-12">
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-full">
                            <label for="Title" class="block text-sm font-medium leading-6 text-gray-900">Full
                                Name</label>
                            <div class="mt-2">
                                <input
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input
                                    ...
                                    type="email" name="email" id="first-name" autocomplete="given-name"
                                    class="p-2 block w-full rounded-md py-1.5 text-gray-900 shadow-sm border">
                            </div>
                        </div>
                        ...
                        @if (!$isEdit)
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input
                                        value="@if ($isEdit) {{ $data->password }}@else{{ old('password') }} @endif"
                                        type="text" name="password" id="last-name" autocomplete="family-name"
