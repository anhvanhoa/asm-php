...
@php
    $isEdit = isset($data);
@endphp
@section('heading', $isEdit ? 'Edit author' : 'Add author')
@section('content')
    <div class="px-4 py-2">
        @if ($errors->any())
        ...
        <form method="POST" enctype="multipart/form-data"
            action="{{ $isEdit ? route('admin.author.edit-handle', $data->id) : route('admin.author.add-handle') }}">
            @csrf
...
@endif
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="flex items-center gap-4">
                                @if ($isEdit)
                                    <div>
                                        <img class="w-32 rounded-md" src="{{ asset('storage/' . $data->avatar) }}"
                                            alt="">
                                    </div>
                                @endif
                                <div
